...
{
//    int h=0, l=0;
//    asm("maccs %0,%1,%2,%3":"=r"(h),"=r"(l):"r"(x),"r"(y),"0"(h),"1"(l));
//    return h;
...
//    if (n < 32)  
//    {  
//        ((int *)&r)[1] = (xHi << n) | (xLo >> (32 - n));  
//        ((unsigned int *)&r)[0] = xLo << n;  
//    }  
//    else  
//    {  
//        ((int *)&r)[1] = xLo << (n - 32);  
...
//    {  
//        ((int *)&r)[1] = xHi >> n;  
//        ((unsigned int *)&r)[0] = (xHi << (32 - n)) | (xLo >> n);  
//    }  
//    else  
//    {  
//        ((int *)&r)[1] = 0;  
//        ((unsigned int *)&r)[0] = xHi >> (n - 32);  
//    }  
//    return r;  
    return x>>n;  
}
...
static __inline int CLZ(int x)
{
    ...
    //not fast asm("clz %0,%1":"=r"(a1),:"r"(a2));
