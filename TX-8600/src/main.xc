...
int main()
{
    ...
    par{    
        ...
        //--------------------------------------------------------------------------------------------------
#if 0
		on tile[1]: {p_eth_reset <: 0x00; delay_milliseconds(1000);p_eth_reset <: 0x01;
        ...
        on tile[1]: {
		    ...
		    // UART TX MODULE	
		    uart_tx_buffered(i_uart_tx[UART_USER],null,1200,115200,UART_PARITY_NONE,8,1,p_uart_tx);
			}
		}
