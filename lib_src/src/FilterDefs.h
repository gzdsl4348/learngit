...
#include "FIR.h"
    ...
    #define        FILTER_DEFS_SSRC_FIR_UP_ID                0 //5            // ID of UP FIR filter
    #define        FILTER_DEFS_SSRC_FIR_UP4844_ID            1 //6            // ID of UP4844 FIR filter
    #define        FILTER_DEFS_SSRC_FIR_UPF_ID               2 //7            // ID of UPF FIR filter
    //#define        FILTER_DEFS_SSRC_FIR_UP192176_ID            8            // ID of UP192176 FIR filter
    #define        FILTER_DEFS_SSRC_FIR_DS_ID               3 //9            // ID of DS FIR filter
    #define        FILTER_DEFS_SSRC_FIR_OS_ID               4 //10            // ID of OS FIR filter
    #define        FILTER_DEFS_SSRC_FIR_NONE_ID             5 //  11            // ID of disabled FIR filter
    /*
